...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
        ...
        WhiteBall whiteBall = new WhiteBall(Color.WHITE, 0, 0, 200, mainPanel);
        ...
        red.addActionListener(l -> {
            if (Ball.getCount() < Ball.TOTAL_NUM) {
                mainPanel.addBallToPanel(new RedBall(Color.RED, 3, 2, 60, mainPanel, whiteBall));
        ...
        blue.addActionListener(l -> {
            if (Ball.getCount() < Ball.TOTAL_NUM) {
                mainPanel.addBallToPanel(new BlueBall(Color.BLUE, 6, 4, 60, mainPanel, whiteBall));
